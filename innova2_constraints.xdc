...
# LEDs - A6=D19, B6=D18 - A6 and B6 are in Bank 90 - High Density
# Both signals are outputs buffered by an inverting buffer
...
#set_property PACKAGE_PIN P27 [get_ports diff_clock_rtl_0_clk_p]
#create_clock -name sys_clk -period 10.000 [get_ports diff_clock_rtl_0_clk_p]
...
# OpenCAPI IIC (I2C) - C2=SCL, B2=SDA - C2 and B2 are in Bank 90
...
# Differential System Clock 100MHz - Bank 65 - High Performance
